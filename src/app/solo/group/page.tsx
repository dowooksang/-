  ...
  return (
    <div className="min-h-screen bg-primary">
      <div className="bg-gradient-to-r from-[#0A103D] via-[#1A2255] to-[#0A103D] py-16 text-center border-b border-white/10">
        ...
        <p className="text-lg text-gray-300">지역별 소모임에 가입하거나 내 밴드에 필요한 멤버를 찾아보세요.</p>
      </div>

      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-white">활성 소모임 / 멤버 모집</h2>
